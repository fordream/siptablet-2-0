...
public class UAStateReceiver extends Callback {
	...
	public void on_call_state(final int callId, pjsip_event e) {
		...
		try {
			...
			// sendBoradCast(callInfo);
			TAUtils.sendBoardcastUpateUI(pjService.service, callInfo);
			Log.d(THIS_FILE, "Call state >>");
	...
	// private void sendBoradCast(SipCallSession callInfo) {
	// Intent intent = SipService.buildCallUiIntent(pjService.service,
	...
	private static class WorkerHandler extends Handler {
		...
		public void setPjService(PjSipService pjService) {
	...
	public void initService(PjSipService srv) {
		...
		msgHandler.setPjService(pjService);
