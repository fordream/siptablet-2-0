...
public class RestClient {
		...
		try {
			...
			case POST: {
				...
				if (params_post != null) {
					...
					// request.setHeader("body", params_post.toString());
	...
	private void executeRequest(HttpUriRequest request, String url) {
		...
		try {
			...
			for (Header header : headers) {
				if (resposeHeader == null) {
					resposeHeader = header.getName() + " : " + header.getValue();
				} else {
					resposeHeader = resposeHeader + " ; " + header.getName() + " : " + header.getValue();
				}
				...
				if ("url".equals(header.getName())) {
					urlheader = header.getValue();
				}
			}
	...
	public String getResposerHeader() {
		return resposeHeader;
	}
