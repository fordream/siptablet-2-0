...
public class TAUser extends SkypeTable {

	public TAUser(Context context) {
		super(context);
		addColumns("user_id");
	...
	public void add(JSONObject group) {
		String where = String.format("%s = '%s'", "user_id", CommonAndroid.getString(group, "user_id"));
		ContentValues values = new ContentValues();

		values.put("user_id", CommonAndroid.getString(group, "user_id"));
		...
		values.put("image", CommonAndroid.getString(group, "image"));
		values.put("mail", CommonAndroid.getString(group, "mail"));
		values.put("status", CommonAndroid.getString(group, "status"));
